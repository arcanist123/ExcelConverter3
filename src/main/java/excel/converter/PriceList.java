...
public class PriceList {
    ...
    public PriceList(Element document) throws IOException {
        ...
        //get the header
        Element documentHeader = (Element) document.getElementsByTagName(Tag.ORGANISATION.toString()).item(0);
        this.documentHeader = new DocumentHeader(documentHeader);
        
        //get the materialsSection
        Element materials = (Element) document.getElementsByTagName(Tag.MATERIALS_SECTION.toString()).item(0);
    ...
    public void writeToXLSX(Sheet mainSheet) {
        ...
        Styles stylesCache = Styles.createInstance(mainSheet.getWorkbook());
