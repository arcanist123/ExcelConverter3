...
public class MaterialGroup {
    ...
    public static MaterialGroup createMaterialGroup(Element materialGroupElement) throws IOException {
        ...
        materialGroup.groupName = materialGroupElement.getElementsByTagName(Tag.GROUP_NAME.toString()).item(0).getTextContent();
        
        //get the material group GUID
        materialGroup.groupGUID = materialGroupElement.getElementsByTagName(Tag.GROUP_GUID.toString()).item(0).getTextContent();
        
        //parse the individual materials into  vector of materials
        NodeList materials = materialGroupElement.getElementsByTagName(Tag.MATERIAL.toString());
